...
The class that contains all details for the re-\/expansion operator (section 4.\-1 of the Lotan 2006 paper) 
...
The X\-Form class constructor. 

The constructor creates an X\-Form class from two matrix coefficients M1 and M2 
\begin{DoxyParams}{Parameters}
{\em M1} & is a matrix coefficient from the first molecule \\
\hline
{\em M2} & is a matrix coefficient from the 2nd molecule \\
\hline
\end{DoxyParams}
...
The X\-Form class reset function. 

Reset the X\-Form object by the given X\-Y\-Z coords and p number of poles
...
The X\-Form class sph\-To\-Cart function. 

Convert a partial deriv in spherical coordinates to cartesian\-: \mbox{[}d\-F/dr, d\-F/dt, d\-F,dphi\mbox{]} to \mbox{[}d\-F/dx, d\-F/dy, d\-F,dz\mbox{]} 
\begin{DoxyParams}{Parameters}
{\em p} & a 3 coordinate function F to convert\\
\hline
\end{DoxyParams}
...
Convert a partial deriv of Grad\-Coeff object in spherical to cartesian\-: 
\begin{DoxyParams}{Parameters}
{\em Gin} & a Grad\-Coeff object to convert\\
\hline
\end{DoxyParams}
Convert a partial deriv of Grad\-Coeff object in spherical to cartesian 
...
The X\-Form undo function. 

Function that replaces current X\-Form values with saved values to revert to an old state. 
...
The X\-Form class xform function. 

The function takes a Matrix coefficient class and computes the gradient of it. 
\begin{DoxyParams}{Parameters}
{\em Min} & is a matrix coefficient for transformation \\
\hline
{\em Gout} & is a gradient coefficient object made from function \\
\hline
{\em b\-For} & is a boolean to indicate whether the input should be transposed for translation coefficients\\
\hline
\end{DoxyParams}
Compute the derivatives of the transformed M\-P coeffs, using E\-Q 47 of Lotan 2006. 
...
The function takes a Matrix coefficient class and computes the re-\/expansion of it, Z= T dot X 
\begin{DoxyParams}{Parameters}
{\em Min} & is a matrix coefficient for transformation \\
\hline
{\em Mout} & is a re-\/expanded coefficient object made from function \\
\hline
{\em b\-For} & is a boolean to indicate whether the input should be transposed for translation coefficients\\
\hline
\end{DoxyParams}
Transform the M\-P coeffs, from the formula given for Mout = T dot Min from Lotan 2006, E\-Q 46. 
...
The function takes a triplet matrix coefficient class and computes the re-\/expansion of the three matrices, Z= T dot X 
\begin{DoxyParams}{Parameters}
{\em Gin} & is a triplet matrix coefficient for transformation \\
\hline
{\em Gout} & is a re-\/expanded triplet coefficient object made from function \\
\hline
{\em b\-For} & is a boolean to indicate whether the input should be transposed for translation coefficients\\
\hline
\end{DoxyParams}
