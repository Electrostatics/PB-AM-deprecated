...
\subsubsection[{operator[]}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf C\-Atom} $\ast$ {\bf A\-A\-::operator}\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
...
\index{operator\mbox{[}$\,$\mbox{]}@{operator[]}!AA@{A\-A}}
\subsubsection[{operator[]}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf C\-Atom}\& {\bf A\-A\-::operator}\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
\item[{int}]{i}
\end{DoxyParamCaption}
