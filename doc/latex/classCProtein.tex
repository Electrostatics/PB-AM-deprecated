...
Initializing protein class $<$ Add each atom in each amino acid of protein to matrix of atoms

$<$ Add charge on atom in each amino acid to vector of charges

$<$ compute center of geometry if the atom

$<$ reposition each atom W\-R\-T to the center of mass of protein

$<$ Total charge of protein

$<$ Total charge of protein to print as output 
...
Compute forces between molecules $<$ Initialize transforms if this is the first force calc of the simulation 
