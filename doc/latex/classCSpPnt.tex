...
Create a Sp\-Pnt class and set r, theta and phi to zero \hypertarget{classCSpPnt_a2d035000bbff43189d79affc0447a9a3}{\index{C\-Sp\-Pnt@{C\-Sp\-Pnt}!C\-Sp\-Pnt@{C\-Sp\-Pnt}}
\index{C\-Sp\-Pnt@{C\-Sp\-Pnt}!CSpPnt@{C\-Sp\-Pnt}}
\subsubsection[{C\-Sp\-Pnt}]{\setlength{\rightskip}{0pt plus 5cm}C\-Sp\-Pnt\-::\-C\-Sp\-Pnt (
\begin{DoxyParamCaption}
...
Create a Sp\-Pnt class and set r, theta and phi to given inputs 
\begin{DoxyParams}{Parameters}
{\em rho} & a real number of radius input \\
\hline
{\em theta} & a real number of theta input \\
\hline
{\em phi} & a real number of phi input \\
\hline
\end{DoxyParams}
