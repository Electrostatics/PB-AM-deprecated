...
Create a Sp\-Pnt class and set xyz to zero \hypertarget{classCPnt_a91907d073421cdf75000d27f982f058b}{\index{C\-Pnt@{C\-Pnt}!C\-Pnt@{C\-Pnt}}
\index{C\-Pnt@{C\-Pnt}!CPnt@{C\-Pnt}}
\subsubsection[{C\-Pnt}]{\setlength{\rightskip}{0pt plus 5cm}C\-Pnt\-::\-C\-Pnt (
\begin{DoxyParamCaption}
\item[{{\bf R\-E\-A\-L}}]{x\-\_\-, }
...
Create a Sp\-Pnt class and set xyz to given inputs 
\begin{DoxyParams}{Parameters}
{\em x} & a real number of radius input \\
\hline
{\em y} & a real number of theta input \\
\hline
{\em z} & a real number of phi input \\
\hline
\end{DoxyParams}
...
The \hyperlink{classCPnt}{C\-Pnt} normsq function. 
...
The \hyperlink{classCPnt}{C\-Pnt} $\ast$= operator. 

Multiply a vector by a scalar s \hypertarget{classCPnt_ab9aa57d527e60e0ba46fd44ee515ebb0}{\index{C\-Pnt@{C\-Pnt}!operator+=@{operator+=}}
...
The \hyperlink{classCPnt}{C\-Pnt} += operator. 
...
Divide a vector by a scalar s \hypertarget{classCPnt_abd18aa7c83ac70f5e73847a8cd154e9d}{\index{C\-Pnt@{C\-Pnt}!operator=@{operator=}}
\index{operator=@{operator=}!CPnt@{C\-Pnt}}
