...
\begin{DoxyCompactList}\small\item\em Distance for molecules to be considered escaped. \end{DoxyCompactList}\item 
...
Distance for molecules to be considered escaped. 
