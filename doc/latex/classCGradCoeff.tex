...
The Grad\-Coeff function sph\-To\-Cart. 

The function that converts each component of the expansion re-\/operator derivatives to cartesian coordinates 
\begin{DoxyParams}{Parameters}
{\em R} & a matrix input of the conversion matrix from spherical to cartesian coordinates, given in E\-Q 48 of Lotan 2006, contained in X\-Form class \\
\hline
\end{DoxyParams}
