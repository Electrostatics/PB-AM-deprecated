...
The Atom class enum P\-L\-A\-C\-E. 

An enumerator for the various positions on a protein that an atom may be found. \begin{Desc}
\item[Enumerator\-: ]\par
\begin{description}
...
Creates an Atom class. using multiple inputs. Maps the given atom to it's O\-P\-L\-S partial charge. 
\begin{DoxyParams}{Parameters}
{\em acode} & an integer containing the atom code (atomic symbol) \\
\hline
{\em rcode} & an integer containing the residue name \\
\hline
{\em resnum} & an integer containing the residue number of atom \\
\hline
{\em x} & a floating point containing the x coordinate of the atom \\
\hline
{\em y} & a floating point containing the y coordinate of the atom \\
\hline
{\em z} & a floating point containing the z coordinate of the atom\\
\hline
\end{DoxyParams}
The Atom class constructor \hypertarget{classCAtom_a55b4b673562699ae2fa4e3386b8d8a9b}{\index{C\-Atom@{C\-Atom}!C\-Atom@{C\-Atom}}
\index{C\-Atom@{C\-Atom}!CAtom@{C\-Atom}}
\subsubsection[{C\-Atom}]{\setlength{\rightskip}{0pt plus 5cm}C\-Atom\-::\-C\-Atom (
\begin{DoxyParamCaption}
...
\begin{DoxyParams}{Parameters}
{\em a} & a \hyperlink{classCAtom}{C\-Atom} object \\
\hline
\end{DoxyParams}
...
The Atom class generate\-Name function. 

A function that generates a 4 character string containing the name of the atom 
\begin{DoxyParams}{Parameters}
{\em acode} & is the integer code of the atom \\
\hline
{\em aname} & a pointer to a character string that is used to identify the atom\\
\hline
\end{DoxyParams}
Generate 4 character sequence for atom name with some bit shifting \hypertarget{classCAtom_a5208b057db97f1c98b3b8fd973a95412}{\index{C\-Atom@{C\-Atom}!get\-Atom\-Code@{get\-Atom\-Code}}
...
The Atom class get\-Atom\-Code function. 

A function that returns a code from the character string 
\begin{DoxyParams}{Parameters}
{\em aname} & a character string of 4 that specifies atom name\\
\hline
\end{DoxyParams}
Generate Atom\-Code from the 4 character string \hypertarget{classCAtom_a909e61ce36305e5e923fd75d48ab6cb8}{\index{C\-Atom@{C\-Atom}!get\-Charge@{get\-Charge}}
...
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf C\-Atom}\& C\-Atom\-::operator= (
\begin{DoxyParamCaption}
\item[{const {\bf C\-Atom} \&}]{a}
\end{DoxyParamCaption}
...
The Atom class set\-Pos function. 

A function that sets the atom position to xyz coords given 
\begin{DoxyParams}{Parameters}
{\em p} & a \hyperlink{classCPnt}{C\-Pnt} object \\
\hline
\end{DoxyParams}
